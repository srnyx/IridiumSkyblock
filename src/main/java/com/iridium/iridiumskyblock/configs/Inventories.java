...
public class Inventories {
    ...
    public SingleItemGUI membersGUI = new SingleItemGUI(27, "&7Island Members", background1, new Item(XMaterial.PLAYER_HEAD, 0, 1, "&b&l%player_name%", "%player_name%", Arrays.asList(
            ...
            "&7Rank: %player_rank%",
            "",
            "&b&l[!] &7Left click to promote",
            "&b&l[!] &7Right click to demote/kick"
    )));
    ...
    public LogInventoryConfig logsGUI = new LogInventoryConfig(27, "&7Island Logs",
            new Item(XMaterial.PLAYER_HEAD, 10, 1, "&b&lIsland Members", "%island_owner%", Arrays.asList("", "&7Page %current_page%/%max_page%", "&b&l[!] &bLeft click to view Next Page", "&b&l[!] &bRight click to view Previous Page")),
            new Item(XMaterial.EMERALD, 11, 1, "&b&lIsland Trusts", Arrays.asList("", "&7Page %current_page%/%max_page%", "&b&l[!] &bLeft click to view Next Page", "&b&l[!] &bRight click to view Previous Page")),
            new Item(XMaterial.LAPIS_LAZULI, 12, 1, "&b&lIsland Invites", Arrays.asList("", "&7Page %current_page%/%max_page%", "&b&l[!] &bLeft click to view Next Page", "&b&l[!] &bRight click to view Previous Page")),
            new Item(XMaterial.GOLD_INGOT, 13, 1, "&b&lIsland Bank", Arrays.asList("", "&7Page %current_page%/%max_page%", "&b&l[!] &bLeft click to view Next Page", "&b&l[!] &bRight click to view Previous Page")),
            new Item(XMaterial.EXPERIENCE_BOTTLE, 14, 1, "&b&lIsland Boosters", Arrays.asList("", "&7Page %current_page%/%max_page%", "&b&l[!] &bLeft click to view Next Page", "&b&l[!] &bRight click to view Previous Page")),
            new Item(XMaterial.BEACON, 15, 1, "&b&lIsland Upgrades", Arrays.asList("", "&7Page %current_page%/%max_page%", "&b&l[!] &bLeft click to view Next Page", "&b&l[!] &bRight click to view Previous Page")),
            new Item(XMaterial.DIAMOND, 16, 1, "&b&lIsland Rewards", Arrays.asList("", "&7Page %current_page%/%max_page%", "&b&l[!] &bLeft click to view Next Page", "&b&l[!] &bRight click to view Previous Page")),
            "&b%user% Joined (%days%d %hours% hours %minutes% minutes %seconds% seconds ago)",
            "&b%user% kicked %target% (%days%d %hours%h %minutes%m %seconds%s ago)",
            "&b%user% Left (%days%d  %hours%h %minutes%m %seconds%s ago)",
            "&b%user% Invited %target% (%days%d %hours%h %minutes%m %seconds%s ago)",
            "&b%user% Uninvited %target% (%days%d %hours%h %minutes%m %seconds%s ago)",
            "&b%user% Promoted %target% (%days%d %hours%h %minutes%m %seconds%s ago)",
            "&b%user% Demoted %target% (%days%d %hours%h %minutes%m %seconds%s ago)",
            "&b%user% Trusted %target% (%days%d %hours%h %minutes%m %seconds%s ago)",
            "&b%user% Untrusted %target% (%days%d %hours%h %minutes%m %seconds%s ago)",
            "&b%user% Deposited %amount% %type% (%days%d %hours%h %minutes%m %seconds%s  ago)",
            "&b%user% Withdrew %amount% %type% (%days%d %hours%h %minutes%m %seconds%s  ago)",
            "&b%user% Purchased %type% booster (%days%d %hours%h %minutes%m %seconds%s  ago)",
            "&b%user% Purchased %type% upgrade (%days%d %hours%h %minutes%m %seconds%s  ago)",
            "&b%user% Redeemed %type% reward (%days%d %hours%h %minutes%m %seconds%s  ago)",
            background2);
